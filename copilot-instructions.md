...
| Surface | Guidance |
| --- | --- |
| Global workflow, safety, Git, and communication | `copilot-instructions.md` |
| File types | `instructions/<type>.instructions.md` |
| GitHub CLI and repository operations | `instructions/github.instructions.md` |
| Code review and promotion readiness | `instructions/review.instructions.md` |
| Lore and session history | `instructions/memory.instructions.md` |
| Shell and CLI execution | `instructions/shell.instructions.md` |
