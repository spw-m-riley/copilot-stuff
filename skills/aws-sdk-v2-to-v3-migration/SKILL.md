...
description: "Use when migrating AWS SDK for JavaScript from v2 patterns (`aws-sdk`, constructors, `.promise()`, DocumentClient, or `s3.upload`) to modular v3 without behavior changes."
metadata:
  kind: task
---
