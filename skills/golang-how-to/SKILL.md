...
- Working with how to in Go code.
- Reviewing or writing Go code that involves how to.
...
- should trigger: "How should I handle how to in Go?"
- should not trigger: "How do I set up a new Go project from scratch?"

## Reference files
- [`references/by-category.md`](references/by-category.md) - by category reference
- [`references/disambiguation.md`](references/disambiguation.md) - disambiguation reference
- [`references/project-config.md`](references/project-config.md) - project config reference
