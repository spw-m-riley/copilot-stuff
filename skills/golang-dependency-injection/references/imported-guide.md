...
description: "Comprehensive guide for dependency injection (DI) in Golang. Covers why DI matters (testability, loose coupling, separation of concerns, lifecycle management), manual constructor injection, and DI library comparison (google/wire, uber-go/dig, uber-go/fx, samber/do). Use this skill when designing service architecture, setting up dependency injection, refactoring tightly coupled code, managing singletons or service factories, or when the user asks about inversion of control, service containers, or wiring dependencies in Go. Wire-specific guidance is included in the parent skill's references alongside the Dig, Fx, and samber/do material."
metadata:
  category: go
...
- [`references/google-wire.md`](./google-wire.md) - support file
- [`references/manual-di.md`](./manual-di.md) - support file
- [`references/samber-do.md`](./samber-do.md) - support file
- [`references/uber-dig-fx.md`](./uber-dig-fx.md) - support file
...
# Imported Go Dependency Injection Guide
...
For small projects, pass dependencies through constructors. See [Manual DI examples](./manual-di.md) for a complete application example.
...
- [google/wire examples](./google-wire.md) — Compile-time code generation
- [uber-go/dig + fx examples](./uber-dig-fx.md) — Reflection-based framework
- [samber/do examples](./samber-do.md) — Generics-based, no code generation
