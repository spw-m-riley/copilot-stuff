...
# Imported Go Design Patterns Guide
...
For code examples, see [Data Handling Patterns](./data-handling.md).
...
For graceful shutdown, resource pools, and `runtime.AddCleanup`, see [Resource Management](./resource-management.md).
...
| Guide | Scope |
| --- | --- |
| [Architecture Patterns](./architecture.md) | High-level principles, when each architecture fits |
| [Clean Architecture](./clean-architecture.md) | Use cases, dependency rule, layered adapters |
| [Hexagonal Architecture](./hexagonal-architecture.md) | Ports and adapters, domain core isolation |
| [Domain-Driven Design](./ddd.md) | Aggregates, value objects, bounded contexts |
...
- [`references/architecture.md`](./architecture.md) - architecture reference
- [`references/clean-architecture.md`](./clean-architecture.md) - clean architecture reference
- [`references/data-handling.md`](./data-handling.md) - data handling reference
- [`references/ddd.md`](./ddd.md) - ddd reference
- [`references/hexagonal-architecture.md`](./hexagonal-architecture.md) - hexagonal architecture reference
- [`references/resource-management.md`](./resource-management.md) - resource management reference
