...
description: "Use when set up or fix a go ci workflow; not when another Go skill is a better fit."
metadata:
  category: go
...
# Imported Go Continuous Integration Guide

Use this skill when you are setting up or fixing CI checks, release jobs, lint gates, or repo automation for Go projects.
...
| --- | --- | --- |
| The request is specifically about go continuous integration. | Yes | - |
| The request is better served by an adjacent Go skill. | No | Route generic Actions failures to [`github-actions-failure-triage`](../../github-actions-failure-triage/SKILL.md) and dependency drift to [`golang-dependency-management`](../../golang-dependency-management/SKILL.md). |

## Guardrails

- Keep the guidance focused on go continuous integration work.
...
- Smoke test:
  - should trigger: "Set up or fix a Go CI workflow."
  - should not trigger: "Change a Go struct field name."
...
- [`assets/claude-code-review.yml`](../assets/claude-code-review.yml)
- [`assets/codecov.yml`](../assets/codecov.yml)
- [`assets/codeql-config.yml`](../assets/codeql-config.yml)
- [`assets/copilot-review-instructions.md`](../assets/copilot-review-instructions.md)
- [`assets/dependabot-auto-merge.yml`](../assets/dependabot-auto-merge.yml)
- [`assets/dependabot.yml`](../assets/dependabot.yml)
- [`assets/docker.yml`](../assets/docker.yml)
- [`assets/goreleaser-cli.yml`](../assets/goreleaser-cli.yml)
- [`assets/goreleaser-lib.yml`](../assets/goreleaser-lib.yml)
- [`assets/goreleaser-monorepo.yml`](../assets/goreleaser-monorepo.yml)
- [`assets/integration.yml`](../assets/integration.yml)
- [`assets/lint.yml`](../assets/lint.yml)
- [`assets/release.yml`](../assets/release.yml)
- [`assets/renovate.json`](../assets/renovate.json)
- [`assets/security.yml`](../assets/security.yml)
- [`assets/test.yml`](../assets/test.yml)
- [`references/repo-security.md`](./repo-security.md)
...
Repository security settings (branch protection, workflow permissions, secrets, environments) form the security foundation for the CI pipeline — these are documented in [repo-security.md](./repo-security.md).
