...
- **Yes, after enabling `composite` or adding project references** → [`tsconfig-hardening`](../../tsconfig-hardening/SKILL.md) (project-references mode)
...
| Set up project references across packages | [`tsconfig-hardening`](../../tsconfig-hardening/SKILL.md) (project-references mode) |
...
| `tsconfig-hardening` (project-references mode) → `tsc-error-triage` | References added but source-level errors remain |
...
- `tsconfig-hardening` in project-references mode surfaces source-level failures unrelated to the reference graph → route those to `tsc-error-triage`
