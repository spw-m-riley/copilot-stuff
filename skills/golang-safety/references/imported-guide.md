---
name: golang-safety
description: "Use when avoid nil or bounds mistakes in go; not when another Go skill is a better fit."
metadata:
  category: go
...
# Imported Go Safety Guide

Use this skill when you are avoiding nil, slice, map, pointer, or bounds mistakes in Go.

## Use this skill when

- The task is about preventing common Go safety footguns.
- You need to reason about nil, bounds, map, slice, or pointer behavior.
...
| --- | --- | --- |
| The request is specifically about go safety. | Yes | - |
| The request is better served by an adjacent Go skill. | No | Route crash investigation to [`golang-troubleshooting`](../../golang-troubleshooting/SKILL.md) and security hardening to [`golang-security`](../../golang-security/SKILL.md). |

## Guardrails

- Keep the guidance focused on go safety work.
...
- Smoke test:
  - should trigger: "Avoid nil or bounds mistakes in Go."
  - should not trigger: "Configure a Go CI workflow."
...
- [`references/nil-safety.md`](./nil-safety.md)
- [`references/slice-map-safety.md`](./slice-map-safety.md)
...
See **[Nil Safety Deep Dive](./nil-safety.md)** for nil receivers, nil in generics, and nil interface performance.
...
See **[Slice and Map Deep Dive](./slice-map-safety.md)** for range pitfalls, subslice memory retention, and `slices.Clone`/`maps.Clone`.
